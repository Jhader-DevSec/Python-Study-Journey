...
| **Fault Tolerance Retrier** | Decorator para criar tolerância a falhas e reexecutar ligações de rede e comandos de sistema operativo automaticamente. | `decorators (@)`, `try/except`, `os` | [Ver Código](./Pasta_Escolhida/fault_tolerance.py) |
